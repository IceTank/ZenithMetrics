...
//    shade("com.github.ben-manes.caffeine:caffeine:3.2.0")
    shade("io.prometheus:prometheus-metrics-core:1.5.0")
    shade("io.prometheus:prometheus-metrics-instrumentation-jvm:1.5.0")
    shade("io.prometheus:prometheus-metrics-exporter-httpserver:1.5.0")
}
